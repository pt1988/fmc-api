...
class IFTDDeviceHABootStrap(object):
    ...
    def __init__(self, shared_key=None, lan_failover=None, enc_key_generation_scheme=None, use_same_link_for_failovers=None, stateful_failover=None, is_encryption_enabled=None):  # noqa: E501
    ...
    def enc_key_generation_scheme(self, enc_key_generation_scheme):
        ...
        if enc_key_generation_scheme not in allowed_values:
            raise ValueError(
    ...
    def use_same_link_for_failovers(self, use_same_link_for_failovers):
        ...
        :type: bool
        """
        if use_same_link_for_failovers is None:

...
class VRFPolicyEntry(object):
    ...
    def __init__(self, l2_switching_enabled=None, tooltip=None, description=None, read_only=None, type=None, uuid=None, mandatory=None, enabled=None, literal=None, name=None, sub_type=None, attributes=None, id=None, position=None, interface_entry_list=None, value=None):  # noqa: E501

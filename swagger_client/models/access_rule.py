...
class AccessRule(object):
    ...
    def __init__(self, metadata=None, snmp_config=None, time_range_objects=None, source_networks=None, syslog_severity=None, source_zones=None, destination_zones=None, description=None, original_source_networks=None, type=None, enable_syslog=None, safe_search=None, enabled=None, dest_sgt_types=None, syslog_config=None, urls=None, end_point_device_types=None, you_tube=None, destination_networks=None, action=None, links=None, network_access_device_i_ps=None, id=None, source_security_group_tags=None, destination_security_group_tags=None, log_end=None, log_begin=None, send_events_to_fmc=None, destination_ports=None, source_ports=None, ips_policy=None, version=None, variable_set=None, users=None, log_files=None, file_policy=None, comment_history_list=None, name=None, vlan_tags=None, applications=None):  # noqa: E501

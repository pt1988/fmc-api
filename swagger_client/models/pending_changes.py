...
class PendingChanges(object):
    ...
    def __init__(self, metadata=None, entity_uuid=None, entity_type=None, value_updated=None, message=None, version=None, value_deleted=None, parent_uuid=None, references_deleted=None, value_added=None, entity_name=None, action=None, links=None, references_added=None):  # noqa: E501

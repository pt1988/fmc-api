...
class LLCollectionTopic(object):
    ...
    def __init__(self, address=None, poll_interval_in_minutes=None, content_bindings=None, name=None, description=None, sub_type=None, type=None, protocol_binding=None, message_binding=None, hash_map=None):  # noqa: E501

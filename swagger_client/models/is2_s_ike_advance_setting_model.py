...
class IS2SIkeAdvanceSettingModel(object):
    ...
    def __init__(self, peer_identity_validation=None, enable_notification_on_tunnel_disconnect=None, threshold_to_challenge_incoming_cookies=None, ike_keepalive_settings=None, identity_sent_to_peer=None, cookie_challenge=None, enable_aggressive_mode=None, maximum_number_of_s_as_allowed=None, percentage_of_s_as_allowed_in_negotiation=None):  # noqa: E501
    ...
    def peer_identity_validation(self, peer_identity_validation):
        ...
        if peer_identity_validation not in allowed_values:
            raise ValueError(
    ...
    def identity_sent_to_peer(self, identity_sent_to_peer):
        ...
        if identity_sent_to_peer not in allowed_values:
            raise ValueError(
    ...
    def cookie_challenge(self, cookie_challenge):
        ...
        if cookie_challenge not in allowed_values:
            raise ValueError(

...
class IBGPAddressFamilyModel(object):
    ...
    def __init__(self, metadata=None, distance=None, inject_maps=None, description=None, auto_summary=None, aftable_map=None, networks=None, type=None, version=None, distribute_lists=None, aggregate_addresses_i_pv6s=None, default_information_orginate=None, neighbors=None, maximum_paths=None, bgp_redistribute_internal=None, aggregate_addresses_i_pv4s=None, bgp_supress_inactive=None, name=None, synchronization=None, links=None, redistribute_protocols=None, id=None):  # noqa: E501

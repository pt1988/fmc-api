...
class AuditModel(object):
    ...
    def __init__(self, metadata=None, sub_system=None, description=None, source=None, type=None, message=None, version=None, domain=None, name=None, start_time=None, links=None, end_time=None, id=None, time=None, username=None):  # noqa: E501

...
class TimeZoneObject(object):
    ...
    def __init__(self, metadata=None, time_zone_id=None, time_zone=None, description=None, overrides=None, type=None, version=None, override_target_id=None, dst_date_range=None, dst_day_recurrence=None, name=None, overridable=None, links=None, id=None):  # noqa: E501

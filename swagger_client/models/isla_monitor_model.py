...
class ISLAMonitorModel(object):
    ...
    def __init__(self, metadata=None, no_of_packets=None, sla_id=None, data_size=None, description=None, threshold=None, interface_names=None, type=None, version=None, timeout=None, interface_objects=None, frequency=None, monitor_address=None, name=None, tos=None, links=None, id=None):  # noqa: E501

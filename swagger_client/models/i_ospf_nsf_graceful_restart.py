...
class IOspfNsfGracefulRestart(object):
    ...
    def __init__(self, nsf_enable=None, nsf_mechanism=None, nsf_helper=None, nsf_restart_intraval=None, nsf_capability=None, nsf_enforce_global=None):  # noqa: E501
    ...
    def nsf_mechanism(self, nsf_mechanism):
        ...
        if nsf_mechanism not in allowed_values:
            raise ValueError(

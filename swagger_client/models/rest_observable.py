...
class RESTObservable(object):
    ...
    def __init__(self, metadata=None, description=None, observable_type=None, type=None, version=None, indicator_count=None, effective_property=None, observable=None, name=None, links=None, id=None, value=None, inherited_property=None, custom_property=None, updated_at=None):  # noqa: E501

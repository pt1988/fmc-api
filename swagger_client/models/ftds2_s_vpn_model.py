...
class FTDS2SVpnModel(object):
    ...
    def __init__(self, endpoints=None, metadata=None, description=None, type=None, ipsec_settings=None, version=None, ike_v1_enabled=None, ike_v2_enabled=None, topology_type=None, advanced_settings=None, name=None, links=None, ike_settings=None, id=None):  # noqa: E501

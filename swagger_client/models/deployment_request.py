...
class DeploymentRequest(object):
    ...
    def __init__(self, metadata=None, force_deploy=None, name=None, device_list=None, ignore_warning=None, description=None, links=None, id=None, type=None, version=None):  # noqa: E501

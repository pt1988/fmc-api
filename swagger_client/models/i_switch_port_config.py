...
class ISwitchPortConfig(object):
    ...
    def __init__(self, port_mode=None, protected_enabled=None, access_mode_vlan_id=None, trunk_mode_allowed_vlan_ids=None, trunk_mode_native_vlan_id=None):  # noqa: E501

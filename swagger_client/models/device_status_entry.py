...
class DeviceStatusEntry(object):
    ...
    def __init__(self, can_be_deployed=None, message_key=None, policy_status_list=None, domain_name=None, is_deploying=None, device_name=None, device_uuid=None, selected=None, current_version=None):  # noqa: E501
    ...
    def message_key(self, message_key):
        ...
        if message_key not in allowed_values:
            raise ValueError(

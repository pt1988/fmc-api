...
class IPatOptionsContainer(object):
    ...
    def __init__(self, block_allocation=None, pat_pool_address=None, include_reserve=None, flat_port_range=None, interface_pat=None, extended_pat=None, round_robin=None):  # noqa: E501

...
class IOspfArea(object):
    ...
    def __init__(self, area_networks=None, default_cost=None, area_id=None, area_type=None, virtual_links=None, area_ranges=None, filter_list=None, authentication=None):  # noqa: E501

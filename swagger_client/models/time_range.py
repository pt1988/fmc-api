...
class TimeRange(object):
    ...
    def __init__(self, metadata=None, effective_end_date_time=None, effective_start_date_time=None, name=None, description=None, links=None, id=None, type=None, recurrence_list=None, version=None):  # noqa: E501

...
class INeighbors(object):
    ...
    def __init__(self, neighbor_timers=None, ipv6_address=None, neighbor_ha_mode=None, ipv4_address=None, neighbor_routes=None, neighbor_advanced=None, type=None, neighbor_local_as=None, neighbor_filtering=None, remote_as=None, link_local_interface=None, name=None, links=None, id=None, neighbor_general=None):  # noqa: E501

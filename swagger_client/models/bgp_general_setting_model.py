...
class BGPGeneralSettingModel(object):
    ...
    def __init__(self, bgp_graceful_restart=None, metadata=None, aggregate_timer=None, transport_path_mtu_discovery=None, scan_time=None, best_path=None, asnotation_dot=None, as_number=None, description=None, bgp_next_hop_trigger_delay=None, bgptimers=None, type=None, bgp_next_hop_trigger_enable=None, version=None, router_id=None, name=None, links=None, fast_external_fall_over=None, id=None, log_neighbor_changes=None, enforce_first_as=None, maxas_limit=None):  # noqa: E501

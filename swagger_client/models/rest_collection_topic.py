...
class RESTCollectionTopic(object):
    ...
    def __init__(self, collection_sub_type=None, collection_address=None, collection_content_binding=None, collection_poll_interval_in_minutes=None, collection_description=None, llcollection_topic=None, type=None, collection_protocol_binding=None, value=None, collection_message_binding=None, collection_name=None):  # noqa: E501

...
class IPPPoEContianer(object):
    ...
    def __init__(self, pppoe_password=None, pppoe_route_metric=None, ip_address=None, vpdn_group_name=None, ppp_auth=None, enable_route_settings=None, store_creds_in_flash=None, pppoe_user=None):  # noqa: E501
    ...
    def ppp_auth(self, ppp_auth):
        ...
        if ppp_auth not in allowed_values:
            raise ValueError(

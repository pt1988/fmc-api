...
class IVpnIkev1Settings(object):
    ...
    def __init__(self, automatic_pre_shared_key_length=None, certificate_auth=None, authentication_type=None, manual_pre_shared_key=None, policy=None):  # noqa: E501

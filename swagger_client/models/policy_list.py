...
class PolicyList(object):
    ...
    def __init__(self, standard_access_list_route_sources=None, metadata=None, ipv4_prefix_list_route_sources=None, interfaces=None, standard_access_list_next_hops=None, description=None, overrides=None, type=None, interface_names=None, ipv4_prefix_list_addresses=None, version=None, standard_access_list_addresses=None, match_community_exactly=None, community_lists=None, metric=None, ipv4_prefix_list_nexthops=None, name=None, overridable=None, action=None, links=None, as_path_lists=None, tag=None, id=None):  # noqa: E501

...
class IAccessPolicyDefaultAction(object):
    ...
    def __init__(self, log_end=None, log_begin=None, metadata=None, snmp_config=None, intrusion_policy=None, send_events_to_fmc=None, description=None, type=None, variable_set=None, version=None, syslog_config=None, name=None, action=None, links=None, id=None):  # noqa: E501

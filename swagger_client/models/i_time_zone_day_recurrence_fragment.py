...
class ITimeZoneDayRecurrenceFragment(object):
    ...
    def __init__(self, start_day_of_week=None, start_week=None, offset=None, start_month=None, start_time=None, end_time=None, end_week=None, end_month=None, end_day_of_week=None):  # noqa: E501
    ...
    def start_week(self, start_week):
        ...
        if start_week not in allowed_values:
            raise ValueError(
    ...
    def start_month(self, start_month):
        ...
        if start_month not in allowed_values:
            raise ValueError(
    ...
    def end_week(self, end_week):
        ...
        """
        allowed_values = ["FIRST", "SECOND", "THIRD", "FOURTH", "LAST"]  # noqa: E501
        if end_week not in allowed_values:
            raise ValueError(
    ...
    def end_month(self, end_month):
        ...
        """
        allowed_values = ["JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC"]  # noqa: E501
        if end_month not in allowed_values:
            raise ValueError(
    ...
    def end_day_of_week(self, end_day_of_week):
        ...
        """
        allowed_values = ["MON", "TUE", "WED", "THU", "FRI", "SAT", "SUN"]  # noqa: E501
        if end_day_of_week not in allowed_values:
            raise ValueError(

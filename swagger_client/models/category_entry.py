...
class CategoryEntry(object):
    ...
    def __init__(self, category_type=None, expanded=None, bread_crumb=None, name=None, categorydescription=None, categorysize=None, id=None, type=None, value=None, uuid=None, category_start=None, literal=None):  # noqa: E501

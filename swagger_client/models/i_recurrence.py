...
class IRecurrence(object):
    ...
    def __init__(self, range_start_time=None, range_end_day=None, range_end_time=None, range_start_day=None, daily_start_time=None, days=None, daily_end_time=None, recurrence_type=None):  # noqa: E501
    ...
    def range_end_day(self, range_end_day):
        ...
        if range_end_day not in allowed_values:
            raise ValueError(

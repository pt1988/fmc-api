...
class FPInterfaceStatistics(object):
    ...
    def __init__(self, metadata=None, rx_bytes=None, tx_bytes=None, interface_uuid=None, name=None, description=None, links=None, id=None, type=None, version=None, dropped_packets=None):  # noqa: E501

...
**literals** | [**list[INetworkAddressLiteral]**](INetworkAddressLiteral.md) | List of network values in group. | [optional] 
**objects** | [**list[INetworkAddress]**](INetworkAddress.md) | The list of member network objects | [optional] 
...
**type** | **str** | Type associated with resource: NetworkGroup. | [optional] 
